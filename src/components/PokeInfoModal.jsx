...
export default function PokeInfoModal() {
  ...
  return (
    <section className={`${isActivate ? 'visible opacity-100' : 'invisible opacity-0'} fixed top-0 right-0 w-full h-screen ${typeColors[modalInfo?.types[0]]} transition-opacity duration-300`}>
